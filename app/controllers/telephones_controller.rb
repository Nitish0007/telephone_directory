class TelephonesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @telephone.save
        format.html { redirect_to telephone_url(@telephone), notice: "Telephone was successfully created." }
  ...
  def update
    respond_to do |format|
      if @telephone.update(telephone_params)
        format.html { redirect_to telephone_url(@telephone), notice: "Telephone was successfully updated." }
  ...
  private
    ...
    def telephone_params
      params.require(:telephone).permit(:first_name, :last_name, :phone, :email, :door_no, :street, :area, :city, :state, :country)
    end
end
